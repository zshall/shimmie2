 ...
 *
 * Modified to use the theme_chooser extension.
 */
class Layout {
	/**
	...
	public function display_page(Page $page) {
		global $config, $database, $userprefs;
...
<html>
	<head>
		...
		<link rel="stylesheet" href="$data_href/themes/$theme_name/$theme_style" type="text/css">
$header_html
	</head>
